I collaborated with Hani Abdel Ghani on this API. We followed the clean architecture from {link} to complete this process. The steps we took:
...
6) We tested our CRUD functions on swagger insuring everything works as intended.
